...
const Body = () => {
  return (
    <div className="relative ">
      <div className="block transform -translate-y-[300px]">
        {/* 1st row */}
        <div className="mb-24">
          <div className="w-4/5 mx-auto flex transform">
            {/* left side */}
            <div className="w-1/2">
              {/* number */}
              ...
              <div className="flex flex-col align-center absolute -right-4 w-1/2 px-8 top-[120px]">
                ...
                <div className="my-5">
                  <p className="font-bold text-sm text-white">
                    ...
                    things you already have. Let’s start with clothing. A
                    typical mistake hiking beginners make is wearing jeans and
                    regular clothes, which will get heavy and chafe wif they get
                    sweaty or wet.
                  </p>
                </div>
                <div className="flex items-center">
